...
const AlumnoDetail = ({activeDetail, setActiveDetail, aluDetail, setAluDetail, actAlu, setActAlu, alumnos}) => {
        ...
        if(e.target.value === ''){
            ...
            if (pattern.test(word)){
                if(alumnos.map((each) => each.nombre.toUpperCase()).indexOf(e.target.value.toUpperCase()) === -1) {
                    ...
                    setNombreFB({...nombreFB, 'text': 'El nombre de alumno ya existe', color: '#CC3636'})
                }
            }
            else{
                setNombreFB({...nombreFB, 'text': 'Escriba un nombre de alumno sin numeros', color: '#CC3636'});
            }
        }
            ...
            {activeDetail &&
                ...
                <div id='profesor-edit-component'>
                    ...
                    <div className='inputlabel'>
                        <InputComponent type={'text'} id={'nombreAlumno'} className={'profesor-add-form-input'} placeholder={actAlu.nombre} onChangeFuncion={handleChangeName} />
