...
const ProfesorDetail = ({activeDetail, setActiveDetail, profeDetail, setProfeDetail, actProfe, setActProfe, profesores}) => {
    ...
    const actualizarProfesor = () =>{
        ...
        nombreProfe == '' ? data.nombre=actProfe.nombre : data.nombre=nombreProfe;
        telProfe == '' ? data.telefono=actProfe.telefono : data.telefono=telProfe;
        ...
        <>
            {activeDetail &&
                ...
                <div id='profesor-edit-component'>
                    ...
                    <div className='inputlabel'>
                        <InputComponent type={'text'} id={'telefonoProfesor'} className={'profesor-add-form-input'} placeholder={actProfe.telefono} onChangeFuncion={handleChangePhone} min={7} max={12}/>
