...
const AlumnosList = ({alumnos}) => {
  ...
  return (
    <div id='alumnos-list-component'>
      <AlumnoDetail activeDetail={activeDetail} setActiveDetail={setActiveDetail} aluDetail={aluDetail} setAluDetail={setAluDetail} actAlu={actAlu} setActAlu={setActAlu} alumnos={alumnos}/>
        ...
        <div id='alumnos-list'>
          {alumnosFiltrados.map((a) => <Alumno key={a.nombre} info={a} setActAlu={setActAlu}></Alumno>)}
        </div>
    </div>
  )
}
