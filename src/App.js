    ...
    <>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path='/reservas' element={<HomeV canchas={canchas} reservas={reservas} reservasLoader={reservasLoader} setSesion={setSesion} alumnos={alumnos} profesores={profesores}/> }></Route>
